...
<body>
    ...
    <table width="30%" align="center" border="2">
        ...
        <tr>
            <th colspan="5">Employee Records</th>
        </tr>

        <tr>
            <td colspan="5"><a href="add_employee.php">Add Record</a></td>
        </tr>
        ...
        ?>
            <tr>
                ...
                <td align="center"><a href="delete_employee.php?id=<?php echo $row['code']; ?>">delete</a></td>
            </tr>
        <?php
        }
